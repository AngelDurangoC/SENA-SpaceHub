    ...
    <div className="max-w-lg mx-auto p-6 bg-slate-800 border border-slate-700 rounded-2xl text-white shadow-xl">
      ...
      <form onSubmit={handleUpdate} className="space-y-4 font-mono text-xs">
        ...
        <div>
          ...
          <select value={estado} onChange={(e) => setEstado(e.target.value as any)} className="w-full bg-slate-900 border border-slate-700 rounded-xl p-2.5 text-white focus:outline-none focus:border-sena-green">
